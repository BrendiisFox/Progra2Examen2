...
public class Evaluador {
	...
	public void testMedioDeTransporte()
	{
		...
		assertEquals("Error", 0, m.getCantidadLlantas());
		assertEquals("Error", 12, m.getCantidad_Pasajeros());
		assertEquals("Error", 200, (int)m.getVelocidadMaxima());
		
		m = new MedioDeTransporte(7, 120);
		assertEquals("Error", 0, m.getCantidadLlantas());
		assertEquals("Error", 7, m.getCantidad_Pasajeros());
	...
	public void testMoto()
	{
		...
		assertEquals("Error", 2, m.getCantidadLlantas());
		assertEquals("Error", 2, m.getCantidad_Pasajeros());
		...
		assertEquals("Error", 2, m.getCantidadLlantas());
		assertEquals("Error", 3, m.getCantidad_Pasajeros());
	...
	public void testCarro()
	{
		...
		assertEquals("Error", 4, c.getCantidadLlantas());
		assertEquals("Error", 4, c.getCantidadLlantas());
		...
		assertEquals("Error", 4, c.getCantidadLlantas());
		assertEquals("Error", 6, c.getCantidadLlantas());
